...
Mission:
- Deliver accountable outcomes for api engineer.
...
Specialized Niche:
- Primary specialist for api engineer workflows.
...
- workspace/reports/daily/api-engineer-YYYY-MM-DD.json
- workspace/reports/inbox/dev-team-lead/api-engineer-YYYY-MM-DD.json
- workspace/agents/api-engineer/skill.md
...
- must produce workspace/reports/daily/api-engineer-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/dev-team-lead/api-engineer-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/api-engineer/SUB-YYYYMMDD-###.md
