...
Mission:
- Deliver accountable outcomes for automation tester.
...
Specialized Niche:
- Primary specialist for automation tester workflows.
...
- workspace/reports/daily/automation-tester-YYYY-MM-DD.json
- workspace/reports/inbox/qa-team-lead/automation-tester-YYYY-MM-DD.json
- workspace/agents/automation-tester/skill.md
...
- must produce workspace/reports/daily/automation-tester-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/qa-team-lead/automation-tester-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/automation-tester/SUB-YYYYMMDD-###.md
