...
Mission:
- Deliver accountable outcomes for build engineer.
...
Specialized Niche:
- Primary specialist for build engineer workflows.
...
- workspace/reports/daily/build-engineer-YYYY-MM-DD.json
- workspace/reports/inbox/devops-lead/build-engineer-YYYY-MM-DD.json
- workspace/agents/build-engineer/skill.md
...
- must produce workspace/reports/daily/build-engineer-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/devops-lead/build-engineer-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/build-engineer/SUB-YYYYMMDD-###.md
