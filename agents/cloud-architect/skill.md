...
Mission:
- Deliver accountable outcomes for cloud architect.
...
Specialized Niche:
- Primary specialist for cloud architect workflows.
...
- workspace/reports/daily/cloud-architect-YYYY-MM-DD.json
- workspace/reports/inbox/cloud-engineering-lead/cloud-architect-YYYY-MM-DD.json
- workspace/agents/cloud-architect/skill.md
...
- must produce workspace/reports/daily/cloud-architect-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/cloud-engineering-lead/cloud-architect-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/cloud-architect/SUB-YYYYMMDD-###.md
