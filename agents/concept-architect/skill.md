...
Mission:
- Deliver accountable outcomes for concept architect.
...
Specialized Niche:
- Primary specialist for concept architect workflows.
...
- workspace/reports/daily/concept-architect-YYYY-MM-DD.json
- workspace/reports/inbox/product-manager/concept-architect-YYYY-MM-DD.json
- workspace/agents/concept-architect/skill.md
...
- must produce workspace/reports/daily/concept-architect-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/product-manager/concept-architect-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/concept-architect/SUB-YYYYMMDD-###.md
