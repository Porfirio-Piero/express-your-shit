...
Mission:
- Deliver accountable outcomes for devops scrum master.
...
Specialized Niche:
- Primary specialist for devops scrum master workflows.
...
- workspace/reports/daily/devops-scrum-master-YYYY-MM-DD.json
- workspace/reports/inbox/devops-lead/devops-scrum-master-YYYY-MM-DD.json
- workspace/agents/devops-scrum-master/skill.md
...
Escalation Path:
- Severity high: escalate to devops-lead immediately.
- Age > 1 day: escalate to devops-lead with mitigation options.
...
- must produce workspace/reports/daily/devops-scrum-master-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/devops-lead/devops-scrum-master-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/devops-scrum-master/SUB-YYYYMMDD-###.md
