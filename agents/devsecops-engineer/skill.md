...
Mission:
- Deliver accountable outcomes for devsecops engineer.
...
Specialized Niche:
- Primary specialist for devsecops engineer workflows.
...
- workspace/reports/daily/devsecops-engineer-YYYY-MM-DD.json
- workspace/reports/inbox/head-of-security/devsecops-engineer-YYYY-MM-DD.json
- workspace/agents/devsecops-engineer/skill.md
...
- must produce workspace/reports/daily/devsecops-engineer-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/head-of-security/devsecops-engineer-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/devsecops-engineer/SUB-YYYYMMDD-###.md
