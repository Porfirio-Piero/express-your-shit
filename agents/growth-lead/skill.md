...
Mission:
- Deliver accountable outcomes for growth lead.
...
Specialized Niche:
- Primary specialist for growth lead workflows.
...
- workspace/reports/daily/growth-lead-YYYY-MM-DD.json
- workspace/reports/inbox/head-of-marketing/growth-lead-YYYY-MM-DD.json
- workspace/agents/growth-lead/skill.md
...
- must produce workspace/reports/daily/growth-lead-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/head-of-marketing/growth-lead-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/growth-lead/SUB-YYYYMMDD-###.md
