...
Mission:
- Deliver accountable outcomes for identity engineer.
...
Specialized Niche:
- Primary specialist for identity engineer workflows.
...
- workspace/reports/daily/identity-engineer-YYYY-MM-DD.json
- workspace/reports/inbox/cloud-engineering-lead/identity-engineer-YYYY-MM-DD.json
- workspace/agents/identity-engineer/skill.md
...
- must produce workspace/reports/daily/identity-engineer-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/cloud-engineering-lead/identity-engineer-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/identity-engineer/SUB-YYYYMMDD-###.md
