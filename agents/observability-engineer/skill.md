...
Mission:
- Deliver accountable outcomes for observability engineer.
...
Specialized Niche:
- Primary specialist for observability engineer workflows.
...
- workspace/reports/daily/observability-engineer-YYYY-MM-DD.json
- workspace/reports/inbox/platform-reliability-lead/observability-engineer-YYYY-MM-DD.json
- workspace/agents/observability-engineer/skill.md
...
- must produce workspace/reports/daily/observability-engineer-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/platform-reliability-lead/observability-engineer-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/observability-engineer/SUB-YYYYMMDD-###.md
