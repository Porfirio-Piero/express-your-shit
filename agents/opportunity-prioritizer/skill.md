...
Agent ID: opportunity-prioritizer
Department: Product
Level: 3
...
Mission:
- Deliver accountable outcomes for opportunity prioritizer.
...
Specialized Niche:
- Primary specialist for opportunity prioritizer workflows.
...
- workspace/reports/daily/opportunity-prioritizer-YYYY-MM-DD.json
- workspace/reports/inbox/product-manager/opportunity-prioritizer-YYYY-MM-DD.json
- workspace/agents/opportunity-prioritizer/skill.md
...
Escalation Path:
- Severity high: escalate to product-manager immediately.
- Age > 1 day: escalate to product-manager with mitigation options.
...
- must produce workspace/reports/daily/opportunity-prioritizer-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/product-manager/opportunity-prioritizer-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/opportunity-prioritizer/SUB-YYYYMMDD-###.md
