...
Mission:
- Deliver accountable outcomes for performance tester.
...
Specialized Niche:
- Primary specialist for performance tester workflows.
...
- workspace/reports/daily/performance-tester-YYYY-MM-DD.json
- workspace/reports/inbox/qa-team-lead/performance-tester-YYYY-MM-DD.json
- workspace/agents/performance-tester/skill.md
...
- must produce workspace/reports/daily/performance-tester-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/qa-team-lead/performance-tester-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/performance-tester/SUB-YYYYMMDD-###.md
