...
Mission:
- Deliver accountable outcomes for pipeline architect.
...
Specialized Niche:
- Primary specialist for pipeline architect workflows.
...
- workspace/reports/daily/pipeline-architect-YYYY-MM-DD.json
- workspace/reports/inbox/devops-lead/pipeline-architect-YYYY-MM-DD.json
- workspace/agents/pipeline-architect/skill.md
...
- must produce workspace/reports/daily/pipeline-architect-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/devops-lead/pipeline-architect-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/pipeline-architect/SUB-YYYYMMDD-###.md
