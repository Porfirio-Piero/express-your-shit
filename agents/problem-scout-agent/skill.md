...
Mission:
- Deliver accountable outcomes for problem scout agent.
...
Specialized Niche:
- Primary specialist for problem scout agent workflows.
...
- workspace/reports/daily/problem-scout-agent-YYYY-MM-DD.json
- workspace/reports/inbox/head-of-marketing/problem-scout-agent-YYYY-MM-DD.json
- workspace/agents/problem-scout-agent/skill.md
...
- must produce workspace/reports/daily/problem-scout-agent-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/head-of-marketing/problem-scout-agent-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/problem-scout-agent/SUB-YYYYMMDD-###.md
