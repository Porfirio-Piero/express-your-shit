...
Mission:
- Deliver accountable outcomes for product owner.
...
Specialized Niche:
- Primary specialist for product owner workflows.
...
- workspace/reports/daily/product-owner-YYYY-MM-DD.json
- workspace/reports/inbox/head-of-product/product-owner-YYYY-MM-DD.json
- workspace/agents/product-owner/skill.md
...
- must produce workspace/reports/daily/product-owner-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/head-of-product/product-owner-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/product-owner/SUB-YYYYMMDD-###.md
