...
Mission:
- Deliver accountable outcomes for product scrum master.
...
Specialized Niche:
- Primary specialist for product scrum master workflows.
...
- workspace/reports/daily/product-scrum-master-YYYY-MM-DD.json
- workspace/reports/inbox/head-of-product/product-scrum-master-YYYY-MM-DD.json
- workspace/agents/product-scrum-master/skill.md
...
- must produce workspace/reports/daily/product-scrum-master-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/head-of-product/product-scrum-master-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/product-scrum-master/SUB-YYYYMMDD-###.md
