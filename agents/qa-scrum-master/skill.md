...
Mission:
- Deliver accountable outcomes for qa scrum master.
...
Specialized Niche:
- Primary specialist for qa scrum master workflows.
...
- workspace/reports/daily/qa-scrum-master-YYYY-MM-DD.json
- workspace/reports/inbox/qa-team-lead/qa-scrum-master-YYYY-MM-DD.json
- workspace/agents/qa-scrum-master/skill.md
...
Escalation Path:
- Severity high: escalate to qa-team-lead immediately.
- Age > 1 day: escalate to qa-team-lead with mitigation options.
...
- must produce workspace/reports/daily/qa-scrum-master-YYYY-MM-DD.json
- must route copy to workspace/reports/inbox/qa-team-lead/qa-scrum-master-YYYY-MM-DD.json
...
- must provide Sub-Agent Brief: workspace/inbox/subagents/qa-scrum-master/SUB-YYYYMMDD-###.md
