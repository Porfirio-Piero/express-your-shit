  ...
  return (
    <main className="min-h-screen bg-ink">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-24 pb-16">
        <h1 className="font-display text-3xl md:text-4xl text-parchment mb-2">Terms of Service</h1>
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-parchment/70 text-sm leading-relaxed">
          ...
          <h2 className="font-display text-xl text-parchment mt-8">1. Service Description</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">2. Eligibility</h2>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">3. Prohibited Uses</h2>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">4. Anti-Harassment Protections</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">5. Anonymity</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">6. Product Claims</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">7. Payments</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">8. Content Moderation</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">9. Studio Reserve Cap</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">10. Refunds</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">11. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="font-display text-xl text-parchment mt-8">12. Changes to Terms</h2>
          <p>
            We may update these terms from time to time. Continued use of the service after changes constitutes 
            acceptance of the updated terms. Material changes will be noted on this page with an updated date.
          </p>

          <h2 className="font-display text-xl text-parchment mt-8">13. Contact</h2>
          <p>
