...
> **Embeddings only.** This skill does not affect chat/completions routing â€”
...
- Lets the user choose an embedding model:
  - `embeddinggemma` (default â€” closest to OpenClaw built-in)
...
- Updates `agents.defaults.memorySearch` in OpenClaw config (surgical â€” only
